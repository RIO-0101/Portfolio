...
//////// TEXT DARK LOAD
var darkTextLoad = document.getElementById("darkTextLoad");
var darkTextLoad2 = document.getElementById("darkTextLoad2");
...
if (getMode && getMode === "dark") {
 ...
 ////// TEXT DARK LOAD 
  darkTextLoad.classList.toggle("darkTextLoad");
  darkTextLoad2.classList.toggle("darkTextLoad2");
...
function reveal(){
  ...
  var skillPer = document.querySelectorAll(".skill-per");
